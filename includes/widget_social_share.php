...
class SocialShare extends WP_Widget {
	...
	{			
		...
		<table class="gctable twitter-accounts-table" data-count="<?php echo count($twitter_accounts); ?>" data-name="<?php echo $this->get_field_name('twitter_accounts'); ?>">
			<thead>
				<tr>
					<th>Account</th>
					<th>First name</th>
		...
		<button type="button" class="add-twitter-account button">Add twitter account</button>

		<h1>Email accounts</h1>			
		<table class="gctable email-accounts-table" data-count="<?php echo count($email_accounts); ?>" data-name="<?php echo $this->get_field_name('email_accounts'); ?>">
			<thead>
				<tr>
					<th>Account</th>
					<th>First name</th>
		...
		<button type="button" class="add-email-account button">Add email account</button>			
		<?php
	}
	...
	{		
		...
		$instance['twitter_accounts'] = $new_instance['twitter_accounts'];
		$instance['email_accounts']   = $new_instance['email_accounts'];
